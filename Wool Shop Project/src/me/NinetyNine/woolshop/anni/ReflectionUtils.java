...
public final class ReflectionUtils {
	 ...
	 *             class with the specified name and package cannot be found
	 ...
	 * @throws InstantiationException If you cannot create an instance of the target
	 *             class due to certain circumstances
	 * @throws IllegalAccessException If the desired constructor cannot be accessed
	 *             due to certain circumstances
	 * @throws IllegalArgumentException If the types of the arguments do not match
	 *             the parameter types of the constructor (this should not occur
	 *             since it searches for a constructor with the types of the
	 *             arguments)
	 ...
	 *             the specified name and parameter types cannot be found
	 * @see DataType#getPrimitive(Class[])
	 * @see DataType#compare(Class[], Class[])
	 */
	 ...
	 * @throws IllegalAccessException If the desired method cannot be accessed due
	 *             to certain circumstances
	 * @throws IllegalArgumentException If the types of the arguments do not match
	 *             the parameter types of the method (this should not occur since it
	 ...
	 * @throws NoSuchFieldException If the desired field of the desired class cannot
	 *             be found
	 * @throws SecurityException If the desired field cannot be made accessible
	 * @throws ClassNotFoundException If the desired target class with the specified
	 *             name and package cannot be found
	 ...
	 * @throws NoSuchFieldException If the desired field of the target class cannot
	 *             be found
	 * @throws SecurityException If the desired field cannot be made accessible
	 * @see #getField(Class, boolean, String)
	 */
	 ...
	 * @return The value of field of the target object
	 * @throws IllegalArgumentException If the target object does not feature the
	 *             desired field (should not occur since it searches for a field
	 *             with the given name in the class of the object)
	 * @throws IllegalAccessException If the desired field cannot be accessed
	 * @throws NoSuchFieldException If the desired field of the target object cannot
	 *             be found
	 * @throws SecurityException If the desired field cannot be made accessible
	 * @see #getValue(Object, Class, boolean, String)
	 */
