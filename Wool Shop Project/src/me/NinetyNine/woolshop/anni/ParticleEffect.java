...
public enum ParticleEffect {
	 ...
	 *             if it requires water and none is at the center location
	 ...
	 * @throws ParticleVersionException If the particle effect is not supported by
	 *             the server version
	 * @throws ParticleColorException If the particle effect is not colorable or the
	 *             color type is incorrect
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				if (ReflectionUtils.PackageType.getServerVersion().charAt(4) == '_') {
					version = Integer
							.parseInt(Character.toString(ReflectionUtils.PackageType.getServerVersion().charAt(3)));
				}
				else {
					version = Integer.parseInt(
							Character.toString(ReflectionUtils.PackageType.getServerVersion().charAt(3))) * 10;
					version += Integer
							.parseInt(Character.toString(ReflectionUtils.PackageType.getServerVersion().charAt(4)));
				}
				if (version > 7) {
